...
Данное приложение является реализацией итогового проекта по первому блоку обучения программированию на С++ "Основные конструкции С++", проводимого на платформе Skillfactory.

В процессе реализации проекта его авторы должны продемонстрировать уровень владения знаниями и навыками программирования на С++, достигнутый ими после завершения первого блока обучения.
...
При этом обязательным условием было использование классов, дополнительно можно
было реализовать обработку исключений и использование шаблонов.
...
С целью исключения возможных неопределенностей при использовании имен весь проект реализован в собственном пространстве имен: **`namespace aiafpb1`**. В этом названии три первых символа соответствуют первым буквам имен авторов проекта, fp - означает final project (итоговый проект), b1 - по блоку 1 курса обучения.

#### <a name="P4"></a> Составные части проекта

Компоненты проекта показаны на диаграмме классов:
...
#### <a name="P6"></a> Авторы проекта
В работе над данным проектом участвовали (в скобках - имена в GitHub):
...
Андрей - реализация класса **`Messages`** и используемой им структуры **`Message`** с подготовкой соответствующего файла Messages.cpp

Айзат - разработка структуры приложения, разработка и реализация классов **`TArray`**, **`TArrayException`**, **`TimeData`**, **`ChatBot`** с используемыми в них структурами и перечислениями, создание файла Main.cpp, подготовка данного файла README.md

Илья - реализация класса **`Users`** и используемой им структуры **`User`** с подготовкой соответствующего файла Users.cpp

#### <a name="P7"></a> Лицензия
Open Source - данный проект доступен для бесплатной загрузки и использования всеми пользователями GitHub.

[Copyright][]
[Copyright]: https://github.com/AyzatV/ConsoleChat/blob/main/README.md